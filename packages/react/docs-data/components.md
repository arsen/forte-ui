...
- **ColorPicker** — Full color selection — saturation/brightness canvas, hue and alpha rails, preset swatches, and a text field that speaks four CSS notations.
...
- **Drawer** — A panel that slides in from any screen edge, with drag-to-dismiss and snap points; for a centered modal use Dialog.
