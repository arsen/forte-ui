...
The divider is a hairline, and a hairline is a 1px target. `.pui-target` widens the hit area to the 24px minimum (SC 2.5.8) without widening the line, so it can be grabbed with a thumb or a shaky hand while still looking like a divider rather than a gutter.
