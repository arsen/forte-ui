...
```tsx
import { Fieldset } from "@dofortech/pretty-ui";
```
...
| --- | --- | --- | --- |
| `--pui-fieldset-gap` | `Fieldset.Root` | Space between the legend and each field | `var(--pui-space-4)` |
| `--pui-fieldset-legend-fg` | `Fieldset.Legend` | Legend colour | `var(--pui-color-foreground)` |
| `--pui-fieldset-legend-font-size` | `Fieldset.Legend` | Legend font size | `var(--pui-font-size-3)` |
| `--pui-fieldset-legend-font-weight` | `Fieldset.Legend` | Legend font weight | `var(--pui-font-weight-semibold)` |
