...
If you find the same part-selector rule in project after project — every app adds a resting shadow to solid buttons, say — that is the signal it should be a knob. [Open an issue](https://github.com/dofortech/forte-ui/issues): adding one is a single declaration plus a doc comment in the component's stylesheet, and it lands in the generated theming tables automatically.
