  ...
  return (
    <div className="grid gap-4">
      <ColorPicker.Root
         ...
         * left out here because it cannot hold the color: it is eight bits a
         * channel, and this design system's tokens are OKLCH. */
        formats={["oklch", "rgb", "hsl"]}
      >
        <ColorPicker.Trigger>Token color</ColorPicker.Trigger>
        <ColorPicker.Popup>
          <ColorPicker.Area />
      ...
      {/* Switching format rewrites the value, not the color — the swatch here
