...
import d_button_loading_src from "./button/loading?raw";
import d_button_sizes from "./button/sizes";
import d_button_sizes_src from "./button/sizes?raw";
import d_button_tones from "./button/tones";
...
import d_switch_disabled_src from "./switch/disabled?raw";
import d_switch_settings_list from "./switch/settings-list";
