...
const RECIPES: { label: string; animation: "pulse" | "shimmer"; style: CSSProperties }[] = [
  {
    ...
    animation: "pulse",
    style: {
      "--pui-skeleton-color": "var(--pui-color-primary-soft)",
      "--pui-skeleton-duration": "2400ms",
    } as CSSProperties,
  },
  {
    ...
    animation: "shimmer",
    style: {
      "--pui-skeleton-radius": "var(--pui-radius-pill)",
      "--pui-skeleton-highlight": "var(--pui-color-primary-soft-active)",
    } as CSSProperties,
  },
  {
    label: "Barely there",
    animation: "pulse",
    style: {
      "--pui-skeleton-color": "var(--pui-color-panel-hover)",
